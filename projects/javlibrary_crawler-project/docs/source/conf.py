# -*- coding: utf-8 -*-
#
# javlibrary_crawler documentation build configuration file, created by
...
copyright = '{}, Angora King'.format(datetime.utcnow().year, package.__author__)
...
# Add data for Jinja2
try:
    from javlibrary_crawler.docs import doc_data
except:
    doc_data = dict()
