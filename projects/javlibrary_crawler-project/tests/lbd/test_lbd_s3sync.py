...
from javlibrary_crawler.lbd.s3sync import low_level_api
from javlibrary_crawler.tests.mock import BaseMockTest
...
if __name__ == "__main__":
    ...
    run_cov_test(__file__, "javlibrary_crawler.lbd.s3sync", preview=False)
